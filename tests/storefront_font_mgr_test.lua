...
describe("storefront_font_mgr", function()
    it("exports required functions", function()
        ...
        assert.is_function(storefront_font_mgr.getInstalledFontsMap)
        assert.is_function(storefront_font_mgr.isFontInstalled)
        assert.is_function(storefront_font_mgr.invalidateInstalledFontsCache)
    end)
    ...
    it("initializes Storefront mixin methods", function()
        ...
        assert.is_function(mockStorefront.getInstalledFontsMap)
        assert.is_function(mockStorefront.isFontInstalled)
        assert.is_function(mockStorefront.getUserFontDirs)
        assert.is_function(mockStorefront.invalidateInstalledFontsCache)
